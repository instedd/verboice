...
next_available_time_with_range_during_same_day_test_() ->
  Schedule = #schedule{time_from = time(10, 00, 00), time_to = time(14, 00, 00)},
...
next_available_time_with_range_ending_next_day_test_() ->
  Schedule = #schedule{time_from = time(18, 00, 00), time_to = time(05, 00, 00)},
...
next_available_time_with_weekdays_test_() ->
  Schedule = #schedule{weekdays = [2, 5]},
