...
-record(hibernated_session_data, {flow, stack, js_context, channel_id, call_flow, call_log_id, project_id, address, contact_id, default_language, status_callback_url, status_callback_user, status_callback_password, resume_ptr}).
