...
Wami.setup = function(options) {
  ...
  function embedWamiSWF(id, initfn) {
    ...
    // Change: inner html wrapped around div with flash-required as an ID
    var version = '10.0.0';
    document.getElementById(id).innerHTML = "<div class=\"flash-required\">WAMI requires Flash "
        + version
        + " or greater<br />https://get.adobe.com/flashplayer/</div>";
