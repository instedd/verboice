...
onWorkflow ->
  ...
  window.step_types = [Play, Menu, Capture, Transfer, Goto, Branch, HangUp, Record, Language, MarkAsFailed, MarkAsSuccessful, HangUpAndCallBack, Nuntium, Impersonate, Hub].concat(External.classes())
