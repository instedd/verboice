...
describe ApplicationsController do
  ...
  it 'Should retrieve a csv with the call traces' do
    ...
    call_log = CallLog.make id: 1, address: 1000
    Trace.make application: app, call_log: call_log, step_id: 1, result: "No key was pressed. Timeout.", step_name: 'Initial menu'
    # Trace.make application: app, call_log: call_log, step_id: 1, result: "User pressed: 2"
    # Trace.make application: app, call_log: call_log, step_id: 1, result: "User pressed: 1"
    # Trace.make application: app, call_log: call_log, step_id: 593, result: "User pressed: 1"
    # Trace.make application: app, call_log: call_log, step_id: 1, result: "User pressed: 1"
    # Trace.make application: app, call_log: call_log, step_id: 593, result: "User pressed: 2"
    # Trace.make application: app, call_log: call_log, step_id: 1, result: "User pressed: 2"
    # Trace.make application: app, call_log: call_log, step_id: 737, result: "No key was pressed. Timeout."
    # Trace.make application: app, call_log: call_log, step_id: 737, result: "No key was pressed. Timeout.", step_name: "Menu Bar"
    # Trace.make application: app, call_log: call_log, step_id: 1, result: "User pressed: 2", step_name: "Menu inicial"
    # Trace.make application: app, call_log: call_log, step_id: 737, result: "User pressed: 2", step_name: "Menu Bar"
